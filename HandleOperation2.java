		...
		do {
			try {
				...
				case 2:
					...
					FileOperation2.createMainFolderIfNotPresent("main");
					List<String> filesToDelete = FileOperation2.displayFileLocations(fileToDelete, "main");
					...
					if (idx != 0) {
						FileOperation2.deleteFileRecursively(filesToDelete.get(idx - 1));
					} else {
						
						// If idx == 0, delete all files displayed for the name
						for (String path : filesToDelete) {
							FileOperation2.deleteFileRecursively(path);
						}
					}
				...
				case 3:
					...
					FileOperation2.createMainFolderIfNotPresent("main");
					FileOperation2.displayFileLocations(fileName, "main");
